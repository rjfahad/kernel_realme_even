...
void susfs_try_umount_all(uid_t uid)
{
	...
	// - For '/data/adb/modules' we pass 'false' here because it is a loop device that we can't
	//   determine whether its dev_name is KSU or not, and it is safe to just umount it if it is a mountpoint
