...
static const struct x86_cpu_id cpu_vuln_blacklist[] __initconst = {
	...
	VULNBL_INTEL_STEPPINGS(KABYLAKE_MOBILE,	X86_STEPPINGS(0x0, 0xC),	SRBDS | MMIO | RETBLEED | GDS),
	VULNBL_INTEL_STEPPINGS(KABYLAKE_DESKTOP,X86_STEPPINGS(0x0, 0xD),	SRBDS | MMIO | RETBLEED | GDS),
